...
const MainTagIcon: FunctionComponent<MainTagIconProps> = ({
  ...
  switch (tag.toLowerCase()) {
    case "css":
      return <i className="fab fa-css3-alt" data-testid="css-icon"></i>;

    case "scss":
      return <i className="fab fa-sass" data-testid="scss-icon"></i>;

    case "js":
      return <i className="fab fa-js-square" data-testid="js-icon"></i>;
    case "react js":
    case "react":
      return <i className="fab fa-react" data-testid="react-icon"></i>;
    case "node js":
    case "node":
      return <i className="fab fa-node-js" data-testid="node-icon"></i>;
    case "next":
    case "next js":
    case "nextjs":
      return (
    ...
    case "webflow":
      return (
        <svg
          ...
          height="50"
          viewBox="0 0 64 64"
          data-testid="webflow-icon"
        >
          <g transform="matrix(2 0 0 2 0 -64)">
            <circle r="16" cy="48" cx="16" fill="#4353ff" />
            <path
